...
// Function to add a new cloth item
  ...
  void initState() {
    super.initState();
    // Initialize the clothList with a default cloth item
    clothList.add({
      'clothName': '',
      'clothType': 'পাঞ্জাবি',
      'clothQuantity': 0,
...
//my variables starts
  ...
  String _selectedCustomerLocation = '';
  String _orderNote = '';
                    ...
                    child: Column(
                      children: [
                        Container(
                            ...
                            width: MediaQuery.of(context).size.width * 95.4,
                            padding: EdgeInsets.only(
                        ...
                        DropdownButtonFormField(
                          ...
                          onChanged: (value) {
                            // if (value == 'সেলোয়ার' || value == 'পায়জামা') {
                            //   setState(() {
                            //     isSeloyar = true;
                            //     isPayjama = true;
                            //   });
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'lomba', value);
                                        // setState(() {
                                        //   _lomba = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardLomba
                                          ? TextInputType
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'hiegh', value);
                                        // setState(() {
                                        //   _hiegh = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardHeigh
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                              ...
                              Row(children: [
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    onChanged: (value) {
                                      _updateClothItem(index, 'komor', value);
                                      // setState(() {
                                      //   _komor = value;
                                      // });
                                    },
                                    ...
                                    keyboardType: useCharacterKeyboardKomor
                                        ? TextInputType
                                            .text // Character keyboard
                                        : TextInputType
                                            .number, // Numeric keyboard
                                ...
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    keyboardType: useCharacterKeyboardPayerMuhri
                                        ? TextInputType
                                            .text // Character keyboard
                                        : TextInputType
                                            .number, // Numeric keyboard
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      keyboardType: useCharacterKeyboardRanerLuj
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'body', value);
                                        // setState(() {
                                        //   _bodyi = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardBody
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'gher', value);
                                        // setState(() {
                                        //   _lomba = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardGher
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'luj', value);
                                        // setState(() {
                                        //   _bodyi = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardLuj
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'puut', value);
                                        // setState(() {
                                        //   _puuti = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardPuut
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'hata', value);
                                        // setState(() {
                                        //   _haatai = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardHata
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      keyboardType: useCharacterKeyboardKolar
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'kop', value);
                                        // setState(() {
                                        //   _haatai = value;
                                        // });
                                      },

                                      keyboardType: useCharacterKeyboardKop
                                          ? TextInputType
                                              .text // Character keyboard
                                          : TextInputType
                                              .number, // Numeric keyboard
                                  ...
                                  Expanded(
                                    child: SwitchListTile(
                                      ...
                                      title: Text('বেন্ড রাউন্ড কলার',
                                          style: TextStyle(fontSize: 14)),
                                      value: clothItem['isBendRoundColar'],
                                      onChanged: (value) {
                                        _updateClothItem(
                                            index, 'isBendRoundColar', value);
                                        // setState(() {
                                  ...
                                  Expanded(
                                    child: SwitchListTile(
                                      ...
                                      title: Text('২ পকেট চেইন',
                                          style: TextStyle(fontSize: 14)),
                                      value: clothItem['isTwoPocketChain'],
                                      onChanged: (value) {
                                        _updateClothItem(
                                            index, 'isTwoPocketChain', value);
                                        // setState(() {
                                        //   _isBendRoundColar = value!;
                                        // });
                                      },
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: SwitchListTile(
                                      ...
                                      onChanged: (value) {
                                        _updateClothItem(index, 'isKop', value);
                                        // setState(() {
                                        //   _isKop = value!;
                                        // });
                                      },
...
//End Panjabi Section SwitchTile
                          ...
                          children: [
                            ...
                            (index + 1 > 1 || clothList.length >= 2)
                                ? ElevatedButton(
                                    ...
                                    onPressed: () => _removeClothItem(index),
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(horizontal: 20, vertical: 20), backgroundColor: GlobalVariables.primaryColor,
                    // onPrimary: Colors.white,
                    shape: RoundedRectangleBorder(
